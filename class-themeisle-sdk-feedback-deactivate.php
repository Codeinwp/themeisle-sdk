...
if ( ! class_exists( 'ThemeIsle_SDK_Feedback_Deactivate' ) ) :
	...
	class ThemeIsle_SDK_Feedback_Deactivate extends ThemeIsle_SDK_Feedback {
        ...
        private $options    = array(
            'I only needed the plugin for a short period'   => array( 'id' => 1, ),
            'The plugin broke my site'                      => array( 'id' => 2, ),
            'I found a better plugin'                       => array( 'id' => 3, 'type' => 'text', 'placeholder' => 'What\'s the plugin\'s name?' ),
            'The plugin suddenly stopped working'           => array( 'id' => 4, ),
            'I no longer need the plugin'                   => array( 'id' => 5, ),
            'It\'s a temporary deactivation. I\'m just debugging an issue.' => array( 'id' => 6, ),
        );
        
        private $other          = array(
            'Other'         => array( 'id' => 999, 'type' => 'textarea', 'placeholder' => 'cmon cmon tell us' ),
        );
...
<?php
        ...
        function get_html() {
            ...
            return '' 
                ...
                . '<div class="actions">'
                . get_submit_button( __( $button_submit ), 'secondary', 'ti-deactivate-yes', false, array( 'disabled' => 'disabled' ) )
        ...
        function post_deactivate() {
            ...
            $this->call_api( array( 'type' => 'deactivate', 'id' => $_POST['id'], 'comment' => isset( $_POST['msg'] ) ? $_POST['msg'] : '' ) );
        }
	}
endif;
