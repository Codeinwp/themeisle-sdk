            ...
            <script type="text/javascript" id="ti-deactivate-js">
                (function ($) {
                    $(document).ready(function () {
                        ...
                        $(target_element).attr('name', '<?php echo esc_html( $heading ); ?><span>Because we care about our clients, please leave us a feedback.</span>').attr('href', '<?php echo $src; ?>').addClass('thickbox');
                        var thicbox_timer;
